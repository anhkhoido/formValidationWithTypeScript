...
const removalButtonProfessionalExp = document.getElementById('removalButtonProfessionalExperience') as HTMLButtonElement;
...
removalButtonProfessionalExp.addEventListener("click", removeProfessionalExperience, false);
...
function removeProfessionalExperience() : void {
    const listOfProfessionalExperiences = document.querySelector('#professionalExperienceContainerId')?.childNodes;
}